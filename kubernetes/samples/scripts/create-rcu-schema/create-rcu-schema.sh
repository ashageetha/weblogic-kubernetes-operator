...
function usage {
  ...
  echo "  -n Namespace/openshift project where RCU is deployed (optional)"
...
kubectl cp ${scriptDir}/common/createRepository.sh  $nameSpace/rcu:/u01/oracle
kubectl cp pwd.txt $nameSpace/rcu:/u01/oracle
